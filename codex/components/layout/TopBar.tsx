...
export function TopBar({
  ...
  return (
    <header className="bg-white">
      <div className="px-[20px] pt-[30px] pb-[18px]">
        ...
        <div className="mt-5 flex items-center justify-between gap-4">
          <div className="c360-actions flex min-w-0 flex-wrap items-center gap-2">
          ...
          <button
            type="button"
            className="inline-flex h-[33px] min-w-[186px] shrink-0 items-center justify-center gap-1.5 rounded-full bg-[#0b7fbd] px-4 text-[13px] font-bold uppercase text-white shadow-[3px_3px_0_rgba(0,0,0,0.18)] hover:bg-[#076fa8]"
          >
